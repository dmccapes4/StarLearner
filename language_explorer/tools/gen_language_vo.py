#!/usr/bin/env python3
"""Bake Language Explorer narration WAVs with ElevenLabs.

Pipeline:
  1. godot --headless --path game -s res://tools/dump_vo_lines.gd
       -> game/data/language_vo_manifest.json   (md5 key -> sentence)
  2. ./tools/gen_language_vo.py                 (this script; idempotent)
...
Voice knobs match other Star Learner titles (warm Matilda / multilingual_v2).
"""
...
MANIFEST = ROOT / "game" / "data" / "language_vo_manifest.json"
