#!/usr/bin/env python3
"""Bake Language Explorer demo-explainer WAVs (docs/demo/vo/) with ElevenLabs.

Reads docs/demo/explainer_narration.json ({lines: [{key, text}]}) and writes
one WAV per line. Same voice knobs as gen_language_vo.py. Idempotent.
"""
...
from gen_language_vo import load_secrets, synth_mp3, to_wav  # noqa: E402
