...
#
# Garden Explorer: offline star/intro clips at game/stars/<id>.ogv
# (see docs/IMPLEMENTATION_PLAN_GARDEN_EXPLORER.md Phase 5).
#
# Usage:
...
ensure_source() {
  ...
  yt-dlp --remote-components ejs:github \
         -f "bv*[height<=720]+ba/b[height<=720]/b[height<=720]" \
