#!/usr/bin/env python3
"""Bake Solar System Explorer narration WAVs with ElevenLabs.

Pipeline:
  1. godot --headless --path game -s res://tools/dump_vo_lines.gd
       -> game/data/solar_vo_manifest.json  (md5 key -> sentence)
  2. ./tools/gen_solar_vo.py               (this script; idempotent)
...
Voice knobs match ant_explorer/tools/gen_vo.py (warm Matilda narrator):
...
MANIFEST = ROOT / "game" / "data" / "solar_vo_manifest.json"
