...
const MAP := {
	...
	# Open carton pre-filled with N eggs (generated by tools/gen_carton_sprites.py).
	# Used to show a carton filling one egg at a time — and a partly-full LAST
	# carton is how division's leftover is made visible.
	"carton_open_1": "carton_open_1.png",
	"carton_open_2": "carton_open_2.png",
	"carton_open_3": "carton_open_3.png",
	"carton_open_4": "carton_open_4.png",
	"carton_open_5": "carton_open_5.png",
	"carton_open_6": "carton_open_6.png",
	"doll": "doll.png",
	"basket": "basket.png",
